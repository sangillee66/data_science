...
| 데이터 유형       | 기존 벡터           | 새로운 벡터       |
|-------------------|---------------------|-------------------|
| 논리형(logical)   | `parse_logical()`   | `col_logical()`   |
| 정수형(integer)   | `parse_integer()`   | `col_integer()`   |
| 실수형(double)    | `parse_double()`    | `col_double()`    |
| 문자형(character) | `parse_character()` | `col_character()` |
| 일시형(datetime)  | `parse_datetime()`  | `col_datetime()`  |
| 날짜형(date)      | `parse_date()`      | `col_date()`      |
| 시간형(time)      | `parse_time()`      | `col_time()`      |
| 범주형(factor)    | `parse_factor()`    | `col_factor()`    |
| 추측형(guess)     | `parse_guess()`     | `col_guess()`     |
| 수치형(number)    | `parse_number()`    | `col_number()`    |
