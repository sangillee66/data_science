...
![**tidyverse**의 핵심 패키지(<https://www.tidyverse.org/>)](images/tidyverse_9.PNG){#fig-tidyverse-packages fig-align="center" width="700"}
...
다음의 세 코드를 비교해 보라. 우선 아래의 경우는 `flights1`과 `flights2`와 같은 중간 변수가 계속 생성되어 메모리를 차지하게 된다.
