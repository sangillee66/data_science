...
여기서는 R로 데이터사이언스를 하는 과정 중 데이터 시각화하기(visualizing)를 다룬다. 데이터 시각화하기는 [**tidyverse**](https://www.tidyverse.org/)의 핵심 패키지 중의 하나인 [**ggplot2**](https://ggplot2.tidyverse.org/) 에서 제공된다.
