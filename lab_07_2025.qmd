---
title: "데이터 사이언스의 과정 복습하기"
subtitle: "AI 융합교육을 위한 인문사회 컨텐츠 설계 실습"
format: 
  revealjs:
...
-   `wpp_2024`의 `pop_jul_total` 데이터를 활용하세요.
...
wpp_2024_tfr |> 
  ...
  geom_boxplot() +
  geom_label_repel(data = wpp_2024_tfr |> 
                     group_by(year) |> 
