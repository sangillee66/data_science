...
title: |
  ...
  | [불러오기와 정돈하기]{style="font-size:1em"} 
...
-   타이디버스의 핵심 패키지 중의 하나: 새로운 데이터 프레임 형식 제공
...
![[https://www.r-bloggers.com/2021/02/4-ways-to-make-data-frames-in-r/](https://www.r-bloggers.com/2021/02/4-ways-to-make-data-frames-in-r/){style="font-size:1.25rem"}](images/clipboard-2404269740.png){fig-align="center"}
...
-   타이디버스의 핵심 패키지 중의 하나: 다양한 포맷의 데이터 불러오기
...
-   타이디버스의 핵심 패키지 중의 하나: '정돈된(tidy)' 데이터 만들기
